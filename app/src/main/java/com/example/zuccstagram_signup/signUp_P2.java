...
public class signUp_P2 extends AppCompatActivity {
    ...
    void setUpUI(){
        ...
        editText_UserName = findViewById(R.id.editText_SecurityQuestion_P3);
        editText_Bio = findViewById(R.id.editText_SecurityQuestionAnswer_P3);
        editText_Password = findViewById(R.id.editText_Password_P2);
        editText_Confirmation_Password = findViewById(R.id.Password_Confirmation_P2);
